...
class MqttPubRecPacket
  ...
  * mqtt-3.1
  ...
  let reason_code: (MqttPubRecReasonCode | None)
  """
  PUBACK Reason Code
  ...
  * mqtt-5
  ...
  new create(
      ...
      reason_code': (MqttPubRecReasonCode | None) = None,
...
primitive MqttPubRecDecoder
  fun apply(reader: Reader, header: U8, remaining: USize, version: MqttVersion = MqttVersion5): MqttDecodeResultType[MqttPubRecPacket] ? =>
...
primitive MqttPubRecMeasurer
  fun variable_header_size(data: MqttPubRecPacket box, maximum_packet_size: (USize | None) = None, version: MqttVersion = MqttVersion5): USize val =>
  ...
  fun properties_size(data: MqttPubRecPacket box, maximum_packet_size: (USize | None) = None): USize val =>
    var size: USize = 0
...
primitive MqttPubRecEncoder
  fun apply(data: MqttPubRecPacket box, maximum_packet_size: (USize | None) = None, version: MqttVersion = MqttVersion5): Array[U8] val =>
