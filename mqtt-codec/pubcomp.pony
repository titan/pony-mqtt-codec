...
type MqttPubCompReasonCode is (MqttSuccess | MqttPacketIdentifierNotFound)
...
class MqttPubCompPacket
  ...
  * mqtt-3.1
  ...
  let reason_code: MqttPubCompReasonCode val
  """
  PUBACK Reason Code
  ...
  * mqtt-5
  ...
  new iso create(
    ...
    reason_code': MqttPubCompReasonCode val = MqttSuccess,
...
primitive MqttPubCompEncoder
  ...
  : Array[U8] val =>
    ...
    if maximum_packet_size != 0 then
      ...
      remaining = MqttPubCompMeasurer.variable_header_size(data, 0, version)
    end
