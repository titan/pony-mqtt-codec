...
class MqttPubCompPacket
  ...
  * mqtt-5
  ...
  new create(
      ...
      reason_code': (MqttPubCompReasonCode | None) = None,
...
primitive MqttPubCompDecoder
  fun apply(reader: Reader, header: U8, remaining: USize, version: MqttVersion = MqttVersion5): MqttDecodeResultType[MqttPubCompPacket] ? =>
...
primitive MqttPubCompMeasurer
  fun variable_header_size(data: MqttPubCompPacket box, maximum_packet_size: (USize | None) = None, version: MqttVersion = MqttVersion5): USize val =>
  ...
  fun properties_size(data: MqttPubCompPacket box, maximum_packet_size: (USize | None) = None): USize val =>
    var size: USize = 0
...
primitive MqttPubCompEncoder
  fun apply(data: MqttPubCompPacket box, maximum_packet_size: (USize | None) = None, version: MqttVersion = MqttVersion5): Array[U8] val =>
